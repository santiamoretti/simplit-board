...
def load_config() -> Config:
    ...
    return Config(domain=dom, auth_url=os.environ.get('SIMPLIT_AUTH_URL', svc('auth')), gateway_url=os.environ.get('SIMPLIT_GATEWAY_URL', svc('cloud-gateway')), control_url=os.environ.get('SIMPLIT_CONTROL_URL', svc('control')), enrollment_url=os.environ.get('SIMPLIT_ENROLLMENT_URL', svc('enrollment')), delivery_url=os.environ.get('SIMPLIT_DELIVERY_URL', svc('delivery')), presence_ws_url=os.environ.get('SIMPLIT_PRESENCE_WS_URL', svc('presence', 'wss')), state_dir=Path(os.environ.get('SIMPLIT_STATE_DIR', '/var/lib/simplit')), trusted_control_pubkey=os.environ.get('SIMPLIT_CONTROL_PUBKEY', ''), trusted_delivery_pubkey=os.environ.get('SIMPLIT_DELIVERY_PUBKEY', ''), org=os.environ.get('SIMPLIT_ORG', 'simplit'))
