...
class TokenProvider:
    ...
    def current(self) -> str:
        with self._lock:
            ...
            if self._token and now < self._exp_ms - 60000:
                return self._token
            resp = requests.post(self._url, json={'clientId': self._client_id, 'clientSecret': self._client_secret}, headers={'Accept': 'application/json'}, timeout=self._timeout)
