...
def verify_job(control_key: Ed25519PublicKey, payload_b64: str, signature_b64: str) -> dict[str, Any]:
    ...
    control_key.verify(_b64(signature_b64), payload_bytes)  # raises cryptography.exceptions.InvalidSignature
...
def verify_signature(pub_key: Ed25519PublicKey, message: bytes, signature_b64: str) -> bool:
    ...
    try:
        ...
        return True
    except Exception:  # InvalidSignature or malformed input
        return False
